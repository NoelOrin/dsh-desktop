...
export function ProviderEditor(props: ProviderEditorProps): ReactNode {
  ...
  const [draft, setDraft] = useState<Record<string, unknown>>(() =>
    draftAt(namespace, settingsPath),
  );
  ...
  const setField = (key: string, next: string | undefined): void => {
    ...
    setDraft((current) =>
      value === undefined ? deletePath(current, [key]) : setPath(current, [key], value),
    );
  };
  ...
  const credentialRequiredFailure =
    props.credentialRequired === true && keyDraft.length > 0 && keyValue.length === 0
    ...
    return (
      <>
        <div className={styles.field}>
          ...
          />
          {shownKeyFailure === undefined ? null : (
              ...
              {ownsIdentity ? (
                <div className={styles.field}>
                  ...
                  <input
                    ...
                    placeholder={
                      stringAt(getPath(namespace.base, settingsPath), "displayName") ??
                      props.provider
                    }
              ...
              {family === "deepseek" ? (
                <DeepSeekModelsEditor
                  ...
                  defaultContextWindow={
                    typeof defaultContextWindow === "number" ? defaultContextWindow : undefined
                  }
                  defaultMaxTokens={
