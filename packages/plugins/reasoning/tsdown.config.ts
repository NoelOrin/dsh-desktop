...
export default defineConfig([
  {
    // host 面：Node ESM，思考强度设置由 client 面提供
  ...
  },
  {
    ...
    name: "@dsh-desktop/plugin-reasoning/client",
    ...
    outputOptions: {
      ...
      banner:
        'window.__ModuleLoader__.load({ id: "@dsh-desktop/plugin-reasoning", factory: (require) => {',
